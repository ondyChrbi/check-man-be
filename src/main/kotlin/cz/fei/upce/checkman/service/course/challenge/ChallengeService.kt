...
class ChallengeService(
    ...
    private fun checkAuthorizeToViewChallenge(challenge: Challenge, appUser: AppUser): Mono<Challenge> {
        return challengeAuthorizationService.isAuthorizedToView(challenge, appUser)
            .flatMap {
                if (!it) {
                    Mono.error(UserNotAuthorizedToViewChallengeException(challenge, appUser))
                } else {
                    Mono.just(challenge)
                }
            }

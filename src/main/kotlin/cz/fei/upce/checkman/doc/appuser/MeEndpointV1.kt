...
@Inherited
@Operation(summary = "Information about current user.", security = [SecurityRequirement(name = "bearerAuth")])
@ApiResponses(
    ApiResponse(
        responseCode = "200",
        description = "Record",
        content = [Content(
            ...
            schema = Schema(implementation = AppUserResponseDtoV1::class)
        )]
    ),
    ApiResponse(
        responseCode = "401",

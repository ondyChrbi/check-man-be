...
@Inherited
@Operation(summary = "Provide all available courses and semesters which can be register by logged user.", security = [SecurityRequirement(name = "bearerAuth")])
@ApiResponses(
    ApiResponse(
        responseCode = "200",
        description = "Record",
...
annotation class MeAvailableCoursesEndpointV1

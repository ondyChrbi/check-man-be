...
@Inherited
@Operation(summary = "Provide all courses and semesters related to logged user.", security = [SecurityRequirement(name = "bearerAuth")])
@ApiResponses(
    ApiResponse(
        responseCode = "200",
        description = "Record",
...
annotation class MeCoursesEndpointV1

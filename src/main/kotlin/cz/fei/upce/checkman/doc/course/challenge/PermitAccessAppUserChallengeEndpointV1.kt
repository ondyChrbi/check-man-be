...
@Inherited
@Operation(summary = "Permit student (app user) to access challenge", security = [SecurityRequirement(name = "bearerAuth")])
@ApiResponses(
    ApiResponse(
        responseCode = "204",
        description = "Success.",
...
annotation class PermitAccessAppUserChallengeEndpointV1

...
@Inherited
@Operation(summary = "Dissable student (app user) to access challenge", security = [SecurityRequirement(name = "bearerAuth")])
@ApiResponses(
    ApiResponse(
        responseCode = "204",
        description = "Success.",
...
annotation class RemoveAccessAppUserChallengeEndpointV1

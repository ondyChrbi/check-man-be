...
@Inherited
@Operation(summary = "Update existing course semester based on id.", security = [SecurityRequirement(name = "bearerAuth")])
@ApiResponses(
    ApiResponse(
        responseCode = "200",
        ...
        content = [Content(
            ...
            schema = Schema(implementation = CourseSemesterResponseDtoV1::class)
        )]
    ),
    ApiResponse(
        responseCode = "400",
...
annotation class UpdateCourseSemesterEndpointV1
